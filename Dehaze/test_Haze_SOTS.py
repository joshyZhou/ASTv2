...
parser = argparse.ArgumentParser(description='Image Dehazing using ASTv2')

parser.add_argument('--input_dir', default='/home/ubuntu/zsh/datasets/promtIR/', type=str, help='Directory of validation images')
parser.add_argument('--result_dir', default='./results/ASTv2/', type=str, help='Directory for results')
parser.add_argument('--weights', default='./preTrained/synHaze_ASTv2.pth', type=str, help='Path to weights')
...
####### Load yaml #######
yaml_file = 'Options/RealDehazing_ASTv2_syn.yml'
import yaml
