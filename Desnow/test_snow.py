...
parser = argparse.ArgumentParser(description='Image Desnowing using ASTv2')
#test_resize286_crop256  test_256
parser.add_argument('--input_dir', default='/home/ubuntu/zsh/datasets/Snow100K/test2000/Snow', type=str, help='Directory of validation images')
parser.add_argument('--result_dir', default='./results/ASTv2/', type=str, help='Directory for results')
parser.add_argument('--weights', default='./preTrained/snow_ast_pami.pth', type=str, help='Path to weights')
...
####### Load yaml #######
yaml_file = 'Options/Desnowing_ASTv2.yml'
import yaml
