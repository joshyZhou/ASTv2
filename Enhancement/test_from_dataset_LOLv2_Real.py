...
parser = argparse.ArgumentParser(
    description='Image Enhancement using ASTv2')

parser.add_argument('--input_dir', default='./Enhancement/Datasets',
                    type=str, help='Directory of validation images')
parser.add_argument('--result_dir', default='./results/tiles/',
                    type=str, help='Directory for results')
parser.add_argument(
    '--opt', type=str, default='./Options/AST_LOL_v2_real.yml', help='Path to option YAML file.')
parser.add_argument('--weights', default='./preTrained/enhancement_LOLv2_Real_ASTv2.pth',
