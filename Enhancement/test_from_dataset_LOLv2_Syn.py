...
parser.add_argument(
    '--opt', type=str, default='./Options/AST_LOL_v2_synthetic.yml', help='Path to option YAML file.')
parser.add_argument('--weights', default='./preTrained/enhancement_LOLv2_Syn_ASTv2.pth',
