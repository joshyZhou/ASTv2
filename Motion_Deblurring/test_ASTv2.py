...
parser = argparse.ArgumentParser(description='Single Image Motion Deblurring using ASTv2')

parser.add_argument('--input_dir', default='/data1/zsh/datasets/deblurring/', type=str, help='Directory of validation images')
parser.add_argument('--result_dir', default='./results/ASTv2', type=str, help='Directory for results')
parser.add_argument('--weights', default='./preTrained/motionblur_ASTv2.pth', type=str, help='Path to weights')
...
####### Load yaml #######
yaml_file = 'Options/Deblurring_ASTv2_L.yml'
import yaml
...
model_restoration = ASTv2(**x['network_g'])
