...
parser = argparse.ArgumentParser(description='Image Deshadowing using ASTv2')
parser.add_argument('--input_dir', default='/home/ubuntu/zsh/datasets/ISTD_Dataset/processed/test/test_A', type=str, help='Directory of validation images')
parser.add_argument('--result_dir', default='./results/ASTv2/', type=str, help='Directory for results')
parser.add_argument('--weights', default='./preTrained/deshaodw_ASTv2.pth', type=str, help='Path to weights')
...
####### Load yaml #######
yaml_file = 'Options/Deshadowing_ASTv2.yml'
import yaml
